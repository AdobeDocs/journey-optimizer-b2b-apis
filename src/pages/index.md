---
title: Journey Optimizer B2B APIs
...
The Journey Optimizer B2B [External Actions API](data-flow.md) enables external services to integrate with Journey Optimizer B2B Edition through custom journey actions.
